...
namespace CardGame
{
    class Program
    {
        ...
        static string[] names = new string[] { "Bob", "Harold", "Marley", "Ebigél", "Fargo", "Carter", "May" };
        ...
        static int MainMenu() {
            ...
            string[] choice = new string[] { "Singleplayer", "Multiplayer", "Local Multi", "Help","Exit" };
        ...
        static void localPlay() {
            ...
            while (NumOfActivePlayers() != 1)
            {
                ...
                if (playerList[index].active)
                {
                    ...
                    //Console.WriteLine(deck.Count +" " +playedCards.Count+" "+sumHand+" "+(sumHand+playedCards.Count+deck.Count));
        ...
        static void Help()
        {
            ...
            Console.WriteLine("\nWe have two special card. C (Color switcher) and +4 these cards doesn\'t have color, but it can be played to any card.");
            Console.WriteLine("\nYou can play these card like this:");
            Console.Write("\t-Play: C ");
            Console.Write("-->Write: c \n");
            Console.WriteLine("\t\t-Now it will ask you letter R, G, B or Y");
            ...
            Console.WriteLine("\t\tb or B --> Switch color to Blue");
            Console.WriteLine("\t\ty or Y --> Switch color to Yellow");
            Console.WriteLine("If you have only 2 card in hand, and you play a card you have to say UNO (uno/Uno also good).\n");
            ...
            Console.Write("]\n");
            Console.WriteLine("Now you can write r6 or +4. But you'll have 1 card in hand! so you have to say UNO. How? It\'s simple. Just write \'uno\' after the played card");
            Console.WriteLine("So you have to write like this:\n\t+4 uno\nOf course it will ask a color because it\'s +4 but you have to write it after the played card");
            Console.ReadKey();
        }
    }
}
